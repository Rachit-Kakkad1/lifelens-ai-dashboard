...
export const insightCards = [
  ...
  },
  {
    ...
    description: "Morning runs reduce daily CO₂ footprint when replacing car commute.",
    confidence: 88,
    category: "eco",
  ...
  },
  {
    ...
    description: "Plant-based meals 3x/week lower carbon by 2.1 kg CO₂.",
    confidence: 82,
    category: "eco",
...
export const simulatorScenario = [
  { week: "W1", energy: 65, co2: 5.8 },
  { week: "W2", energy: 70, co2: 5.0 },
  { week: "W3", energy: 74, co2: 4.6 },
  { week: "W4", energy: 78, co2: 4.2 },
  { week: "W5", energy: 80, co2: 3.8 },
  { week: "W6", energy: 84, co2: 3.4 },
];

export const weeklyMission = {
  title: "Cycle 3× this week",
